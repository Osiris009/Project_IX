...
#include "IX_UI/UIAsyncActions/AsyncAction_PushSoftWidget.h"
...
UAsyncAction_PushSoftWidget* UAsyncAction_PushSoftWidget::PushSoftWidget(const UObject* WorldContextObject,
	...
	UPARAM(meta = (Categories = "IXUI.WidgetStack")) FGameplayTag InWidgetStackTag,
...
{
	UIX_UISubsystem* IXUISubsystem = UIX_UISubsystem::Get(CachedOwningWorld.Get());
	IXUISubsystem->PushSoftWidgetToStackAsync(CachedWidgetStackTag, CachedSoftWidgetClass, 
